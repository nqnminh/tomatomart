...
const Target = () => {
  ...
  const legend = [
    { title: 'Mục tiêu doanh thu tuần', dot: 'rgba(3, 211, 181, 0.85)', amount: wTarget },
    { title: 'Mục tiêu doanh thu hàng tháng', dot: 'rgba(102, 109, 146, 0.85)', amount: mTarget }
  ];


  return(
    <div className="Target admin-col">
      <h3 className="bt-header">Mục tiêu</h3>
      <Chart 
        options={options}
        series={series}
        type="radialBar"
